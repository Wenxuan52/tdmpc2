...
class WorldModel(nn.Module):
	...
	def __repr__(self):
		...
		modules = ['Encoder', 'Dynamics', 'Reward', 'Termination', 'Policy prior', 'Contrastive score', 'Q-functions']
		for i, m in enumerate([self._encoder, self._dynamics, self._reward, self._termination, self._pi, self._F, self._Qs]):
